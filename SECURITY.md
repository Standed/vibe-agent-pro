...
**中文翻译**：
> **需要立即采取行动**
> 修复已在 **19.0.1**、**19.1.2** 和 **19.2.1** 版本中引入。
> 如果您正在使用上述任何包，请立即升级到任何修复版本。
...
- [Next.js 安全最佳实践](https://nextjs.org/docs/app/building-your-application/deploying/production-checklist#security)
- [npm 安全审计文档](https://docs.npmjs.com/cli/v8/commands/npm-audit)
