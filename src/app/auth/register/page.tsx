...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-[#0a0a0a] overflow-hidden relative px-4">
      ...
      {showBetaModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-in fade-in duration-200">
          <div className="premium-panel max-w-md w-full p-8 shadow-2xl transform transition-all animate-in zoom-in-95 duration-200">
