          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white dark:bg-cine-dark border border-light-border dark:border-cine-border rounded-xl shadow-xl w-[900px] max-w-[96vw] max-h-[88vh] overflow-hidden flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="glass-input w-full mt-1 rounded-xl p-2 text-sm text-gray-900 dark:text-white"
                      >
              ...
              <div className="flex justify-end gap-2 px-4 py-3 border-t border-light-border dark:border-cine-border">
                <button
                  onClick={() => setEditingShot(null)}
                  className="px-3 py-2 text-sm rounded-lg glass-button text-gray-600 dark:text-gray-300"
                >
                  取消
                </button>
                <button
                  onClick={saveShotEdit}
                  className="px-3 py-2 text-sm rounded-lg bg-black dark:bg-white text-white dark:text-black font-medium shadow-md hover:scale-105 transition-transform"
                >
                  保存并应用
                </button>
              </div>
