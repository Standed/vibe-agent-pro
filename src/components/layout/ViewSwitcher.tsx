        ...
        <div className={cn("fixed top-6 left-6 z-[200] pointer-events-auto", className)} ref={containerRef}>
            <div className="relative">
                ...
                <button
                    ...
                    className={cn(
                        "flex items-center gap-2.5 px-3 py-2 premium-card !rounded-2xl transition-all duration-300 group active:scale-95",
                        isOpen ? "ring-2 ring-primary/20" : "hover:scale-[1.02]"
                    )}
                >
                    <div className={cn(
                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            className="absolute top-full left-0 mt-2 w-52 premium-panel !rounded-2xl overflow-hidden p-1.5"
                        >
